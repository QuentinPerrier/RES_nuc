...
loop(nuc,
         ...
         display cost.l;
         display capa.l;
*execute_unload should have a different name in each loop
...
*CORRECT IT!
         put summary_csv;
*        summary_csv.pc=5;
         put nuc.tl, COST.l, CAPA.l('onshore') , CAPA.l('pv'), CAPA.l('nuclear'), gene_tec('onshore'), gene_tec('pv') , gene_tec('nuclear') /
; );
*-------------------------------------------------------------------------------
*                                The End :D
*-------------------------------------------------------------------------------
